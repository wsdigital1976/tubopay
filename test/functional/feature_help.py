...
"""Verify that starting tubopay with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tubopay with -h for help text")
        ...
        self.log.info("Start tubopay with -version for version information")
        ...
        self.log.info("Start tubopayd with -fakearg to make sure it does not start")
