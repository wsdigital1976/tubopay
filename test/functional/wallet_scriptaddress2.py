...
#
# Test new TuboPay multisig prefix functionality.
#
...
class ScriptAddress2Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(multisig_addr[0], 'B')
        ...
        priv_keys = ["cU7eeLPKzXeKMeZvnEJhvZZ3tLqVF3XGeo1BbM8dnbmV7pP3Bg89",
        ...
        assert_equal(multisig_addr_new, 'BZ974ZrPrmqMmm1PSVp4m8YEgo3bCBZBbe')
        multisig_addr_old = "2N5nLwYz9qfnGdaFLpPn3gS6oYBbmLTWPjq"
