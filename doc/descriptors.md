# Support for Output Descriptors in TuboPay Core

Since TuboPay Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `tubo1...` for mainnet or `ttubo1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on TuboPay's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing TuboPay Core wallets, a convenience function `combo` is
