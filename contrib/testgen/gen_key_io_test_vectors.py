...
bech32_templates = [
  ...
  ('tubo',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('tubo',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('tubo',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('ttubo',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('ttubo',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('ttubo',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rtubo',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rtubo',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rtubo', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('ttubo',  17, 32, False, False, False),
  ('rtubo',  3,  1, False, False, False),
  ('tubo',   15, 41, False, False, False),
  ('ttubo',  0, 16, False, False, False),
  ('rtubo',  0, 32, True,  False, False),
  ('tubo',   0, 16, True,  False, False),
  ('ttubo',  0, 32, False, True,  False),
  ('rtubo',  0, 20, False, False, True)
]
