...
const char * const BITCOIN_CONF_FILENAME = "tubopay.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TuboPay";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TuboPay";
#else
    // Unix
    return pathRet / ".tubopay";
#endif
#endif
}
