...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tubopay-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tubopay-tx [options] <hex-tx> [commands]  Update hex-encoded tubopay transaction\n" +
            "or:     tubopay-tx [options] -create [commands]   Create hex-encoded tubopay transaction\n" +
            "\n";
